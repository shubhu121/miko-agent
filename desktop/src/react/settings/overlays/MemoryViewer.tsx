...
export function MemoryViewer() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('miko-view-memories', handler);
    return () => window.removeEventListener('miko-view-memories', handler);
  }, []);
  ...
  const loadMemories = async () => {
    ...
    try {
      ...
      const res = await mikoFetch(`/api/memories?agentId=${aid}`);
