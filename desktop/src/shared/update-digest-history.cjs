...
const DEFAULT_RELEASES_API = "https://api.github.com/repos/shubhu121/miko-agent/releases?per_page=20&page=1";
const DEFAULT_RELEASE_ASSET_BASE = "https://github.com/shubhu121/miko-agent/releases/download";
  ...
  try {
    const response = await fetchImpl(url, {
      headers: {
        ...
        "User-Agent": "Miko-update-history",
      },
