...
export function SkillCapabilities({ installCfg }: SkillCapabilitiesProps) {
  ...
  return (
    <>
      ...
      {showGithubWarning && (
        <div className="miko-warning-overlay" onClick={() => setShowGithubWarning(false)}>
          <div className="miko-warning-box" onClick={(e) => e.stopPropagation()}>
            <h3 className="miko-warning-title">{t('settings.skills.fetchWarning.title')}</h3>
            <div className="miko-warning-body">
            ...
            <div className="miko-warning-actions">
              <button className="miko-warning-cancel" onClick={() => setShowGithubWarning(false)}>
                {t('common.cancel')}
              </button>
              <button className="miko-warning-confirm" onClick={confirmGithubFetch}>
      ...
      {showSafetyWarning && (
        <div className="miko-warning-overlay" onClick={() => setShowSafetyWarning(false)}>
          <div className="miko-warning-box" onClick={(e) => e.stopPropagation()}>
            <h3 className="miko-warning-title">{t('settings.skills.safetyWarning.title')}</h3>
            <div className="miko-warning-body">
            ...
            <div className="miko-warning-actions">
              <button className="miko-warning-cancel" onClick={() => setShowSafetyWarning(false)}>
                {t('common.cancel')}
              </button>
              <button className="miko-warning-confirm" onClick={async () => {
