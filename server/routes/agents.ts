...
export function createAgentsRoute(engine) {
  ...
  route.post("/agents", async (c) => {
    try {
      ...
      return c.json({ error: err.message }, err.statusCode || (err.message.includes("This feature is available in English only.") ? 409 : 500));
    }
  });
  ...
  route.delete("/agents/:id", async (c) => {
    try {
      ...
      const code = err.message.includes("cannot delete the last agent") ? 400
        : err.message.includes("This feature is available in English only.") ? 400
        : err.message.includes("This feature is available in English only.") ? 404
        : 500;
  ...
  // ════════════════════════════
  //  ConfigEnglish onlyconfig.yamlEnglish only
  // ════════════════════════════
  ...
  // ════════════════════════════
  //  IdentityEnglish onlyidentity.mdEnglish only
  // ════════════════════════════
  ...
  // ════════════════════════════
  //  IshikiEnglish onlyishiki.mdEnglish only
  // ════════════════════════════
  ...
  // ════════════════════════════
  //  Public IshikiEnglish onlypublic-ishiki.mdEnglish only
  // ════════════════════════════
  ...
  // ════════════════════════════
  //  PinnedEnglish onlypinned.mdEnglish only
  // ════════════════════════════
