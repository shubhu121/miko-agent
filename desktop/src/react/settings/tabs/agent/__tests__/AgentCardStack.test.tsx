...
describe('AgentCardStack', () => {
  it('renders the primary badge from the server-provided isPrimary flag', () => {
    const agents: Agent[] = [
      { id: 'agent-a', name: "This feature is available in English only.", yuan: 'miko', isPrimary: false },
      { id: 'agent-b', name: "This feature is available in English only.", yuan: 'butter', isPrimary: true },
    ];
