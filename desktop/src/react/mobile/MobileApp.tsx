...
const MOBILE_UPDATE_AVAILABLE_EVENT = 'miko-mobile-update-available';
const MOBILE_APPLY_UPDATE_EVENT = 'miko-mobile-apply-update';
...
export function MobileApp(): React.ReactElement {
  ...
  const [mobileUpdateAvailable, setMobileUpdateAvailable] = useState(() => window.__mikoMobileUpdateAvailable === true);
  ...
  useEffect(() => {
    ...
    if (window.__mikoMobileUpdateAvailable === true) setMobileUpdateAvailable(true);
  ...
  return (
    <main className="onboarding">
      <section className="onboarding-step active">
        <img className="onboarding-avatar" src={mikoMascot} alt="" />
        <h1 className="onboarding-title">Miko</h1>
