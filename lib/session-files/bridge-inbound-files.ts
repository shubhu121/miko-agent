...
export async function materializeBridgeInboundFiles({
  ...
  files,
  registerSessionFile,
}: { mikoHome?: any; sessionId?: any; sessionPath?: any; files?: any[]; registerSessionFile?: any } = {}) {
  if (!files?.length) {
    return { sessionFiles: [], imageAttachmentPaths: [], displayAttachments: [] };
  }
  if (!mikoHome) throw new Error("bridge inbound file materialization requires mikoHome");
