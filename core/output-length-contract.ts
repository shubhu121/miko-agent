...
function unitLabel(unit: OutputLengthUnit, locale?: string): string {
  ...
  return unit === "words" ? "This feature is available in English only." : "This feature is available in English only.";
}
...
function buildRepairInstruction(contract: OutputLengthContract, evaluation: OutputLengthEvaluation): string {
  ...
  const label = contract.label || "This feature is available in English only.";
