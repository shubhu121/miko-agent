...
description: Use Miko Media Generation tools for image and video generation. Read before calling media_generate-image, media_generate-video, or media_describe-options.
---
...
- Provider capability comes from Miko Media Provider Registry, not from chat model names.
