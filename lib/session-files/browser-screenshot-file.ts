...
export function browserScreenshotPath(mikoHome, sessionPath, { base64, mimeType, sessionId = null }: { base64?: any; mimeType?: any; sessionId?: any } = {}) {
  return path.join(
...
export async function persistBrowserScreenshotFile({
  ...
  mimeType = "image/png",
  registerSessionFile,
}: { mikoHome?: any; sessionId?: any; sessionPath?: any; base64?: any; mimeType?: string; registerSessionFile?: any } = {}) {
  if (typeof registerSessionFile !== "function") {
    throw new Error("browser screenshot requires registerSessionFile");
  }
  const filePath = browserScreenshotPath(mikoHome, sessionPath, { base64, mimeType, sessionId });
