...
// Keep these prompt strings aligned with Pi SDK's compaction prompts. Miko's
...
function hardTruncateCachePreservingCompaction(branchEntries, preparation, {
  ...
  summary = "[Earlier conversation history was hard-truncated because the conversation and compaction request exceeded the context limit (miko-cache-preserving-compaction).]",
} = {}) {
