...
const CHANNEL_COMPOSER_FOCUS_EVENT = 'miko-channel-composer-focus';
...
export function AgentPhoneSessionPreview({ sessionPath, agentId, agentYuan }: {
  ...
  const phoneNotice = t('channel.phoneReceivedNewMessages') || "This feature is available in English only.";
...
export function ChannelReadonly() {
  ...
  return (
    <span>
      ...
      {window.t?.('channel.readOnly') || "This feature is available in English only."}
    </span>
  );
}
