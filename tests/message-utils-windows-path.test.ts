...
describe("Windows session path validation", () => {
  it("accepts the same path when only drive and user-directory casing differs", () => {
    const agentsDir = "C:\\Users\\Alice\\.miko\\agents";
    const sessionPath = "c:\\users\\alice\\.miko\\agents\\miko\\sessions\\old.jsonl";
  ...
  it("treats archived desktop sessions as desktop but not active", () => {
    const agentsDir = "C:\\Users\\Alice\\.miko\\agents";
    const sessionPath = "c:\\users\\alice\\.miko\\agents\\miko\\sessions\\archived\\old.jsonl";
  ...
  it("still rejects sibling paths that only share a textual prefix", () => {
    const agentsDir = "C:\\Users\\Alice\\.miko\\agents";
    const sessionPath = "C:\\Users\\Alice\\.miko\\agents-evil\\miko\\sessions\\old.jsonl";
