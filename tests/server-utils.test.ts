...
describe("resolveAgentStrict", () => {
  it("This feature is available in English only.", () => {
    const engine = mockEngine({ miko: { id: "miko" }, _focus: { id: "_focus" } });
    expect(resolveAgentStrict(engine, mockCtx("miko"))).toEqual({ id: "miko" });
  });
...
describe("This feature is available in English only.", () => {
  it("This feature is available in English only.", () => {
    const engine = mockEngine({ miko: { id: "miko" }, _focus: { id: "_focus" } });
    expect(resolveAgent(engine, mockCtx("miko"))).toEqual({ id: "miko" });
  });
