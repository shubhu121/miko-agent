...
async function materializeDocxImages({
  ...
  if (!mikoHome || !sessionPath || typeof recordFileOperation !== "function") {
...
export function wrapReadOfficeMedia(tool, cwd, {
  ...
  getSessionIdForPath,
  recordFileOperation,
}: { mikoHome?: any; getVisionBridge?: any; isVisionAuxiliaryEnabled?: any; getSessionPath?: any; getSessionIdForPath?: any; recordFileOperation?: any } = {}) {
