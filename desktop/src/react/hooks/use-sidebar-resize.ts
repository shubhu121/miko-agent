...
export function useSidebarResize(): void {
  ...
  useEffect(() => {
    ...
    const savedLeft = localStorage.getItem('miko-sidebar-width');
    const savedRight = localStorage.getItem('miko-jian-width');
    const savedChannelInspector = localStorage.getItem('miko-channel-inspector-width');
    const savedPreview = localStorage.getItem('miko-preview-width');
    ...
    setupHandle(
      ...
      LEFT_MIN, LEFT_MAX, 'miko-sidebar-width', false,
    );
    ...
    setupHandle(
      ...
      (w) => applyJianWidth(w),
      RIGHT_MIN, RIGHT_MAX, 'miko-jian-width', true,
    );
    ...
    setupHandle(
      ...
      CHANNEL_INSPECTOR_MIN, CHANNEL_INSPECTOR_MAX, 'miko-channel-inspector-width', true,
    );
    ...
    setupHandle(
      ...
      PREVIEW_MIN, getPreviewMaxWidth, 'miko-preview-width', true,
    );
