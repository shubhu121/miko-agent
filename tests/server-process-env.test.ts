...
describe("Windows server process environment", () => {
  it("canonicalizes duplicate PATH keys and keeps package runner lookup paths", () => {
    const env = normalizeWin32ProcessEnv({
      ...
      prependPathEntries: ["C:\\Miko\\resources\\git\\cmd"],
      appendPathEntries: ["C:\\Users\\miko\\AppData\\Roaming\\npm", "c:\\program files\\nodejs"],
    });

    expect(env).not.toHaveProperty("Path");
    expect(env.PATH.split(";")).toEqual([
      "C:\\Miko\\resources\\git\\cmd",
      "C:\\Windows\\System32",
      "C:\\Program Files\\nodejs",
      "C:\\stale\\bin",
      "C:\\Users\\miko\\AppData\\Roaming\\npm",
    ]);
  ...
  it("merges registry PATH entries into the server environment without duplicate path keys", async () => {
    ...
    expect(env).toEqual({
      PATH: "C:\\Miko\\resources\\git\\cmd;C:\\Windows\\System32;C:\\Program Files\\nodejs",
      PATHEXT: ".COM;.EXE;.BAT;.CMD",
      ComSpec: "C:\\Windows\\System32\\cmd.exe",
    });
  });
