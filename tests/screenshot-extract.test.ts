...
describe('extractScreenshotPayload', () => {
  ...
  it('mixed roles → conversation mode', () => {
    const messages = [
      { id: '1', role: 'user' as const, text: "This feature is available in English only." },
      { id: '2', role: 'assistant' as const, blocks: [{ type: 'text' as const, html: "This feature is available in English only." }] },
    ];
    ...
    const messages = [
      {
        id: '1', role: 'assistant' as const, blocks: [
          ...
          { type: 'mood' as const, yuan: 'miko', text: 'happy' },
