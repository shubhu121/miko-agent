...
describe('ChatArea continuous bottom scroll', () => {
  beforeEach(() => {
    ...
    useStore.setState({
      ...
      sessions: [{ path: '/chat/scroll.jsonl', agentId: 'miko', title: null, firstMessage: '', modified: '', messageCount: 1 }],
      streamingSessions: ['/chat/scroll.jsonl'],
      agents: [{ id: 'miko', name: 'Miko', yuan: 'miko' }],
    } as never);
  ...
  it('mounts a current empty session panel instead of leaving the chat area blank', async () => {
    useStore.setState({
      ...
      sessions: [{ path: '/chat/empty.jsonl', agentId: 'miko', title: null, firstMessage: '', modified: '', messageCount: 0 }],
      streamingSessions: [],
    } as never);
        ...
        '/chat/scroll.jsonl': {
          items: [{
            ...
            data: {
              id: 'a-quote',
              role: 'assistant',
              blocks: [{ type: 'text', html: "This feature is available in English only.", source: "This feature is available in English only." }],
            },
          }],
          hasMore: false,
          loadingMore: false,
