...
const OFFICE_PDF_HELPER_FLAG = "--miko-office-html-to-pdf";
...
function normalizeJob(raw) {
  ...
  return {
    ...
    embedMikoFonts: raw.embedMikoFonts !== false,
...
async function renderJob(job) {
  ...
  const fontCss = job.embedMikoFonts ? buildFontInjectionCss() : null;
