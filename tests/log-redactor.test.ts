...
describe("log redaction", () => {
  ...
  it("redacts local home paths across macOS, Linux, Windows, and file URLs", () => {
    const raw = [
      ...
      "/home/bob/.miko/auth.json",
      "C:\\Users\\carol\\AppData\\Roaming\\Miko\\crash.log",
      "C:/Users/dave/AppData/Roaming/Miko/crash.log",
    ].join("\n");
  ...
  it("redacts object values by sensitive key without mutating the original object", () => {
    const raw = {
      userId: "u-123456",
      chatId: "chat-789",
      sessionPath: "/Users/alice/.miko/agents/a/sessions/s.md",
      nested: {
    ...
    expect(cleaned).toEqual({
      userId: "[redacted]",
      chatId: "[redacted]",
      sessionPath: "~/.miko/agents/a/sessions/s.md",
      nested: {
        password: "[redacted]",
        safe: "hello",
      },
