...
export function BrowserViewerApp() {
  ...
  useEffect(() => {
    ...
    miko?.onSettingsChanged?.((type: string, data: unknown) => {
      if (type === 'theme-changed' && isThemePayload(data)) setTheme(data.theme);
    });

    
    miko?.onBrowserUpdate?.((data: BrowserViewerUpdate) => {
      ...
      <div className="toolbar">
        <div className="toolbar-left">
          ...
          <button
            ...
            onClick={() => miko?.closeBrowserViewer?.()}
          >
          ...
          <button
            ...
            onClick={() => miko?.browserEmergencyStop?.(sessionPath)}
          >
          ...
          <button
            ...
            onClick={() => miko?.browserGoBack?.(sessionPath)}
          >
          ...
          <button
            ...
            onClick={() => miko?.browserGoForward?.(sessionPath)}
          >
            <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button
            ...
            onClick={() => miko?.browserReload?.(sessionPath)}
          >
        ...
        <div className="browser-tab-strip">
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  title={tabTitle(tab)}
                  onClick={() => miko?.browserSwitchTab?.(tab.tabId, sessionPath)}
                  onDoubleClick={() => miko?.browserCloseTab?.(tab.tabId, sessionPath)}
                >
                  ...
                  <span
                    ...
                    onClick={(event) => {
                      ...
                      miko?.browserCloseTab?.(tab.tabId, sessionPath);
                    }}
          ...
          <button
            ...
            onClick={() => miko?.browserNewTab?.(sessionPath)}
          >
            <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round">
              <path d="M7 3v8M3 7h8" />
            </svg>
