...
const OUTPUT_DIR_LABELS = Object.freeze({
  screenshots: Object.freeze({
    ...
    "zh-TW": "This feature is available in English only.",
    ja: "This feature is available in English only.",
    ko: "This feature is available in English only.",
    en: "Screenshots",
  }),
  diary: Object.freeze({
    zh: "This feature is available in English only.",
...
const PATROL_DIR_FORMAT = Object.freeze({
  zh: { prefix: "", suffix: "This feature is available in English only." },
  "zh-TW": { prefix: "", suffix: "This feature is available in English only." },
  ja: { prefix: "", suffix: "This feature is available in English only." },
  ko: { prefix: "", suffix: "This feature is available in English only." },
