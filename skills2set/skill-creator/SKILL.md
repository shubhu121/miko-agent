---
name: skill-creator
description: "Create, update, validate, and evaluate skills. Use when users want to create a skill, improve an existing skill, run skill evaluations, benchmark skill performance, or improve triggering accuracy. MANDATORY TRIGGERS: create skill, new skill, improve skill, skill eval, benchmark skill, validate skill, package skill."
...
- It finds Python through `MIKO_SKILL_CREATOR_PYTHON`, `python3`, `python`, or Windows `py -3`.
