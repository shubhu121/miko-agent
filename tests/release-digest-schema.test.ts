    ...
    items: [
      {
        ...
        summary: { zh: "This feature is available in English only.", en: "The About page shows update details." },
        details: [],
...
describe("appendDigestToHistory (append semantics)", () => {
  ...
  it("replaces the head entry when re-run for the same version (idempotent hand-edit loop)", () => {
    ...
    edited.summary = { zh: "This feature is available in English only.", en: "Revised summary." };
